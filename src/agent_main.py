...
from src.utils.xml_operations import (
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print(
            "  plan [spec_file]      - Generate a plan from specification (default: spec.md)"
        )
            ...
            try:
                ...
                if user_input.startswith("/"):
                    ...
                    if cmd == "plan" and len(parts) > 1:
                        ...
                        print(
                            "  /plan <spec_file> - Generate a plan from specification"
                        )
                        print("  /display - Display the current plan")
                        print("  /execute <task_id> - Execute a specific task")
