...
def process_command(
    ...
    # Handle memory commands
        ...
        try:
            ...
            formatted_memory = pretty_format_xml(ET.tostring(memory_root, encoding='unicode'))
    ...
    # Handle plan commands
        ...
        try:
            ...
            console.print("\n[bold blue]Generating plan...[/bold blue]")
            try:
    ...
    # Handle history commands
        ...
        messages_to_show = chat_history[-count:] if len(chat_history) > count else chat_history
        
        console.print(f"[bold blue]Chat History (last {len(messages_to_show)} messages):[/bold blue]")
